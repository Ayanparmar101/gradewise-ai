...
import { FileText, Mic, Video, Shield, BarChart3, Sparkles, CheckCircle2, Zap, Lock } from "lucide-react";
const features = [{
  icon: FileText,
  ...
  return <section className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="container px-4">
        ...
        once: true
          ...
          {features.map((feature, index) => <motion.div key={index} variants={itemVariants} className="group relative p-8 rounded-2xl bg-card border border-border hover:border-primary/30 transition-all duration-300 hover:shadow-lg">
              {/* Icon */}
              ...
              <ul className="space-y-2">
                {feature.highlights.map((highlight, i) => <li key={i} className="flex items-center gap-2 text-sm text-muted-foreground">
